					...
					<div className="auto-area" style={{height: Clientheight-91}}>
						<div className="left-area" style={{position: 'relative'}}>
							...
							<div className="product-detail" style={{position: 'relative', maxHeight: '55%',}}>
								<div className="eachBlock" style={{display: 'inline-block', width: '100%',paddingTop:'30px'}}>
								...
								<h1 style={{display: 'inline-block', width: '100%', position: 'relative',paddingTop:'30px'}}><span>Components used:</span></h1>
								...
								<br></br>
								<h1 style={{display: 'inline-block',width: '100%',paddingTop:'30px'}}><span>Description:</span></h1>
						...
						<div className="right-area">
							<div className="product-image" style={{width: '100%', position: 'relative', overflow: 'hidden', maxHeight: '45%',backgroundColor:'#aed0da',cursor:'pointer'}}>
							...
							<div className="project-video">
								...
								<h3 style={{display: 'inline-block',width: '100%',paddingBottom:'20px',fontWeight:'normal'}}>Video Link for the project:</h3><br></br>
								<input style={{display: 'inline-block', width: '100%',border: 'none', fontSize: '19px', lineHeight: '32px', height: '38px', backgroundColor:'E0EFF4', borderLeft: 'none',paddingLeft: '4px'}} type="text" name="country" placeholder="Enter the URL" onChange={this.valueVideoUrlChanged} value={this.state.VideoUrl}></input>
							</div>										</div>
			...
			<div id="project" className="inner" style={{width: '100%', height: '100%', backgroundImage: 'url(images/newbisoft-screens-15.png)',backgroundSize: 'contain',backgroundPosition:'center'}}>
				...
				<section id="product">
					<div className="auto-area" style={{height: Clientheight-91}}>
						...
						<div className="right-area">
							<div onClick={this.imageShow} className="product-image" style={{width: '100%', position: 'relative', overflow: 'hidden', maxHeight: '45%',backgroundColor:'#aed0da',cursor:'pointer'}}>
								<img width="100%" height="100%" id='screenshot' src={this.state.imgURL} alt="Bisoft"/>
							</div>
							<div className="project-video">
								<div className="eachBlock" style={{display: 'inline-block', width: '100%'}}>
