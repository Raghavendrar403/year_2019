	        ...
	        if(this.state.showloading==true){
	        	...
	        	leftArea=(<div className="left-area" style={{position: 'relative'}}>
							...
							<div className="product-detail" style={{position: 'relative',maxHeight: '55%',}}>
								...
								<input style={{display: 'inline-block', width: '100%', position: 'relative', fontSize: '18px', marginBottom: '8px', lineHeight: '32px', height: '38px', backgroundColor:'E0EFF4', borderLeft: 'none',}} type="text" name="country" value={currentProjectData["name"]} readOnly></input>
								</div>
								<div className="eachBlock" style={{display: 'inline-block', width: '100%'}}>
								...
								<input style={{display: 'inline',width:'100%',overflowY:'hidden',overflowX:'auto',wordWrap:'break-word',position: 'relative',fontSize: '18px', marginBottom: '8px', lineHeight: '32px', height: '38px', backgroundColor:'E0EFF4', borderLeft: 'none',paddingLeft: '4px'}} type="text" name="country" value={currentProjectData["componentsUsed"]} readOnly></input>
								<br></br>
								<h1 style={{display: 'inline-block',width: '100%'}}><span>Description</span></h1>
								<p style={{display: 'inline-block', width: '100%', border: 'none', fontSize: '19px', marginBottom: '8px', lineHeight: '32px', height: '38px', backgroundColor:'E0EFF4', borderLeft: 'none',paddingLeft: '4px'}}>{currentProjectData["head"]}{currentProjectData["desc"]}</p>
