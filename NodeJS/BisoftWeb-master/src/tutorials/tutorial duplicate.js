...
var Utils = requirse(__base+'./src/utils');
var App = require('../App'); 
...
const msgAtStyles={
    concept:{
      1:{position:'absolute',padding:'5px 0px',backgroundColor:'#fff',top:'57px',zIndex:'10000',marginLeft: '33%'},
      2:{position:'absolute',padding:'5px 0px',backgroundColor:'#fff',top:'-128px',left:'492px',zIndex:'10000',marginLeft:'-10px',marginTop:'140px'}
    },
    assembly:{
      1:{position:'absolute',zIndex:'10000',marginLeft:'30%',marginTop:'0%'},
      2:{position:'absolute',zIndex:'10000',marginLeft:'30%',marginTop:'0%'}
    },
    logic:{
      1:{position:'absolute',zIndex:'10000',marginLeft:'33%'},
      2:{position:'absolute',padding:'5px 0px',backgroundColor:'#fff',top:'590px',left:'-250px',marginTop:'0'},
      3:{position:'absolute',zIndex:'10000',marginLeft:'33%'},
      4:{},
      5:{}
    }
};
    ...
    if(this.props.tutorialMode=="true"){
      if(this.state.show==false){
        return(<div style={{display: 'none'}}></div>);
          ...
          var firstTabStyle = msgAtStyles["concept"][1];
          ...
          return (
                 ...
                 <div className='overlay-example' style={firstTabStyle}>
              <br></br>
