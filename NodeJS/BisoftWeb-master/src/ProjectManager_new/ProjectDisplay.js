...
var ProjectDisplay= React.createClass({
	...
	render: function() {
        ...
        if(this.state.showloading==true){
        	...
        	leftArea=(<div className="left-area" style={{position: 'relative'}}>
						<div className="product-image" style={{width: '100%', position: 'relative', overflow: 'hidden', maxHeight: '45%'}}>
							<img width="100%" height="100%" src={currentProjectData["imgsource"]} alt="Bisoft"/>
						</div>
						<div className="product-detail" style={{position: 'relative',maxHeight: '40%', overflow: 'auto'}}>
							...
							<input style={{display: 'inline-block', width: '67%', position: 'relative', borderTop: '3px solid #00aad9', fontSize: '18px', marginBottom: '14px', lineHeight: '32px', height: '38px', backgroundColor:'E0EFF4', borderLeft: 'none',paddingLeft: '4px'}} type="text" name="country" value={currentProjectData["name"]} readOnly></input>
							</div>
							<div className="eachBlock" style={{display: 'inline-block', width: '100%'}}>
							<h1 style={{display: 'inline-block', width: '33%', position: 'relative'}}><span>Bibox type:</span></h1>
							<input style={{display: 'inline-block', width: '67%', position: 'relative', borderTop: '3px solid #00aad9', fontSize: '18px', marginBottom: '14px', lineHeight: '32px', height: '38px', backgroundColor:'E0EFF4', borderLeft: 'none',paddingLeft: '4px'}} type="text" name="country" value={currentProjectData["biboxType"]} readOnly></input>
							</div>
							<h1 style={{display: 'inline-block', width: '100%', position: 'relative'}}><span>Components used:</span></h1>
							<input style={{display: 'inline',width:'100%',overflowY:'hidden',overflowX:'auto',wordWrap:'break-word',position: 'relative', borderTop: '3px solid #00aad9',fontSize: '18px', marginBottom: '14px', lineHeight: '32px', height: '38px', backgroundColor:'E0EFF4', borderLeft: 'none',paddingLeft: '4px'}} type="text" name="country" value={currentProjectData["componentsUsed"]} readOnly></input>
							
							<br></br>
							<h1 style={{display: 'inline-block',width: '100%'}}><span>Description</span></h1>
							<p style={{marginTop: '2px'}}>{currentProjectData["head"]}{currentProjectData["desc"]}</p>
