					...
					<div className="auto-area" style={{height: Clientheight-91}}>
						<div className="left-area" style={{position: 'relative'}}>
							...
							<div className="product-detail" style={{position: 'relative', maxHeight: '40%', overflow: 'auto'}}>
								...
								<input style={{display: 'inline-block', width: '67%', position: 'relative', fontSize: '19px', marginBottom: '14px', lineHeight: '32px', height: '38px', backgroundColor:'E0EFF4', borderLeft: 'none',paddingLeft: '4px'}} type="text" name="country" onChange={this.valueChanged} value={this.state.Projectvalue}></input>
								</div>
								<div className="eachBlock" style={{display: 'inline-block', width: '100%'}}>
								<h1 style={{display: 'inline-block', width: '33%', position: 'relative'}}><span>Bibox type:</span></h1>
								<input style={{display: 'inline-block', width: '67%', position: 'relative', fontSize: '19px', marginBottom: '14px', lineHeight: '32px', height: '38px', backgroundColor:'E0EFF4', borderLeft: 'none',paddingLeft: '4px'}} type="text" name="country" value="Bibox Hornbill"></input>
								</div>
								<h1 style={{display: 'inline-block', width: '33%', position: 'relative'}}><span>Components used:</span></h1>
								<input style={{display: 'inline-block', width: '67%', position: 'relative', fontSize: '19px', marginBottom: '14px', lineHeight: '32px', height: '38px', backgroundColor:'E0EFF4', borderLeft: 'none',paddingLeft: '4px'}} type="text" name="country" value={componentsListAsString}></input>
								<br></br>
