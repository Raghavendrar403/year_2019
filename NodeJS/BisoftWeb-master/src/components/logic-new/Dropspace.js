...
var Workspace = React.createClass({
  ...
  updateConnections: function (index, connections) {
    ...
    var connectionsCopy = jQuery.extend(true, {}, connections);
    logicNew.cardConnections[index].connections = connectionsCopy;

    if(DraggingInfo.existingCard){
        ...
        logicNew.cardConnections[parentCardId].connections[ParenttoPort].to = childCardId;
        logicNew.cardConnections[parentCardId].connections[ParenttoPort].toPort = 0;
