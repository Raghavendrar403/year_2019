    ...
    if(this.state.currentLogicScreen=='hexa'){
          ...
          return (
            <div>
                <div className="textButton" style={{position: 'fixed',float: 'right',right: '0',zIndex: 9999,marginTop: '2%',width: '20%'}}>
                  <div><button style={{float: 'left',marginRight: '1%',padding: 0,border: '3px solid #F9CB2F',backgroundColor: '#F9CB2F',color: 'grey'}} disabled type="button" onClick={this.LogicButtonClicked}><img title = "Hexa Screen" style={{height: '40px',width: '40px'}} src="./images/1-logic.png"/></button>
                    <button style={{float: 'left',marginRight: '1%',padding: 0,border: '3px solid transparent'}} type="button" onClick={this.LogicFlowButtonClicked}><img title = "Logic Screen" style={{height: '40px',width: '40px'}} src="./images/2-logic.png"/></button>
        ...
        return (
          ...
          <div id="mainMenu" style={{height: '100%'}}>
            <div className="textButton" style={{position: 'fixed',float: 'right',right: '0',zIndex: 9999,marginTop: '2%',width: '20%'}}>
                  <div><button style={{float: 'left',marginRight: '1%',padding: 0,border: '3px solid transparent'}} type="button" onClick={this.LogicButtonClicked}><img title = "Hexa Screen" style={{height: '40px',width: '40px'}} src="./images/1-logic.png"/></button>
                    <button style={{float: 'left',marginRight: '1%',padding: 0,border: '3px solid transparent'}} type="button" onClick={this.LogicFlowButtonClicked}><img title = "Logic Screen" style={{height: '40px',width: '40px'}} src="./images/2-logic.png"/></button>
                    <button style={{float: 'left',marginRight: '1%',padding: 0,border: '3px solid #F9CB2F'}} disabled type="button" onClick={this.editorButtonClicked}><img title = "Coding Screen" style={{height: '40px',width: '40px'}} src="./images/3-logic.png"/></button></div>
      ...
      return (
        ...
        <div className="textButton" style={{position: 'fixed',float: 'right',right: '0',zIndex: 9999,marginTop: '2%',width: '20%'}}>
                  <div><button style={{float: 'left',marginRight: '1%',padding: 0,border: '3px solid transparent'}} type="button" onClick={this.LogicButtonClicked}><img title = "Hexa Screen" style={{height: '40px',width: '40px'}} src="./images/1-logic.png"/></button>
                      <button style={{float: 'left',marginRight: '1%',padding: 0,border: '3px solid #F9CB2F',backgroundColor: '#F9CB2F',color: 'grey'}} disabled type="button" onClick={this.LogicFlowButtonClicked}><img title = "Logic Screen" style={{height: '40px',width: '40px'}} src="./images/2-logic.png"/></button>
                      <button style={{float: 'left',marginRight: '1%',padding: 0,border: '3px solid transparent'}} type="button" onClick={this.editorButtonClicked}><img title = "Coding Screen" style={{height: '40px',width: '40px'}} src="./images/3-logic.png"/></button></div>
