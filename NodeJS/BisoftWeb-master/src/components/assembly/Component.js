...
var Component = React.createClass({
  ...
  render: function() {
     if(this.props.type=="geared_motor"){
        ...
        var width = 140 * scale;
         ...
         return connectDragSource(
          <div style={{ ...style, left, top, backgroundImage: 'url(images/component_' + type + '.png)', height, width}}
            ...
            onMouseUp={this.checkForLongPress} onDoubleClick={this.typeCheck}/>
        );
     }
      ...
      else if(this.props.type=="dot_matrix"){
        const { type, left, top, scale, connectDragSource, isDragging, children } = this.props;
        if (isDragging) {
          return null;
        }
       ...
       else if(this.props.type=="4_CH_relay"){
        const { type, left, top, scale, connectDragSource, isDragging, children } = this.props;
        if (isDragging) {
          return null;
        }
        ...
        var height = ImageSizes[ItemTypes.COMPONENT][1] * scale;
        var width = ImageSizes[ItemTypes.COMPONENT][0] * scale;
